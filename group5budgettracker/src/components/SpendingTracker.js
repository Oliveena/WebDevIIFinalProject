...
export default function SpendingTracker() {
  ...
  { name: 'Pashmina Scarf', amount: 30, category: 'Clothes', date: '2025-06-14' },

  // Transport - June
  { name: 'Bus Ticket', amount: 2.75, category: 'Transport', date: '2025-06-01' },
  { name: 'Opus Card Monthly', amount: 90, category: 'Transport', date: '2025-06-01' },
  { name: 'Car Payment', amount: 300, category: 'Transport', date: '2025-06-03' },
  ...
  { name: 'July Rent (early)', amount: 1200, category: 'Rent', date: '2025-06-15' },

  // Utilities - June
  { name: 'Hydro-Québec', amount: 200, category: 'Utilities', date: '2025-06-02' },
  { name: 'Cellphone Bill', amount: 50, category: 'Utilities', date: '2025-06-03' },
  { name: 'Internet', amount: 65, category: 'Utilities', date: '2025-06-04' },
  { name: 'Plumbing Repairs', amount: 275, category: 'Utilities', date: '2025-06-14' },

  // Food - May
  { name: 'Groceries', amount: 95, category: 'Food', date: '2025-05-10' },
  { name: 'Dinner with Friends', amount: 60, category: 'Food', date: '2025-05-15' },
  { name: 'Coffee', amount: 4, category: 'Food', date: '2025-05-18' },
  { name: 'Bakery', amount: 10, category: 'Food', date: '2025-05-20' },

  // Clothes - May
  { name: 'Summer Dress', amount: 45, category: 'Clothes', date: '2025-05-05' },
  ...
  // Utilities - May
  { name: 'Electric Bill', amount: 190, category: 'Utilities', date: '2025-05-07' },
  ...
  // Transport - April
  { name: 'Car Payment', amount: 300, category: 'Transport', date: '2025-04-01' },
  ...
  // Utilities - April
  { name: 'Water Bill', amount: 70, category: 'Utilities', date: '2025-04-05' },
  { name: 'Cellphone Bill', amount: 50, category: 'Utilities', date: '2025-04-15' },
  ...
  // Transport - March
  { name: 'Bus Ticket', amount: 3, category: 'Transport', date: '2025-03-12' },
  ...
  // Utilities - March
  { name: 'Electric Bill', amount: 180, category: 'Utilities', date: '2025-03-07' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
            Track your
            <span className="block text-primary-600">spending effortlessly</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Visualize where your money goes and keep tabs on your spending habits over time.
          </p>
        </div>
        ...
        {/* Table of Expenses */}
        <div>
          <h3 className="text-2xl font-semibold text-gray-900 mb-4 p-5">Recent Expenses</h3>
